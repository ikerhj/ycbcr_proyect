...
module  d8m_mipi_clk_gate_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //d8m_mipi_clk_gate_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  d8m_mipi_clk_gate_altclkctrl_0  (
    inclk,
    outclk);
    ...
    d8m_mipi_clk_gate_altclkctrl_0_sub  d8m_mipi_clk_gate_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
